<section id="insta" class="mobile-diff section slide_six" data-anchor="insta">
    <div class="row align-items-center ml-0 mr-0">
        ...
        <div class="col-11 col-md-9 mx-auto mx-lg-0 mt-5">
            <div class="row nopadding nomargin">
                <div class="col-12">
                    <h2 class="oranienbaum text-white">Мой блог в Instagram  с аудиторией </h2>
                    <h2 class="main-color oranienbaum">более 28 000 человек</h2>
                </div>
                ...
                <div class="col-md-4 col-12 mb-3">
                    <img width="100%" src="layouts/img/inst2.png" alt="">
                </div>
                <div class="col-md-4 col-12 mb-3">
                    <img width="100%" src="layouts/img/inst3.png" alt="">
                </div>
